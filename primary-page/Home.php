                        ...
                        <div class="card-body">
                            ...
                            <div class="modal-dialog">
                                ...
                                <form method="post" action="proses.php">
                                    ...
                                    <button type="submit" name="submit_transaksi" class="bg-danger border-0 shadow text-light rounded-2 p-2">Submit Pesanan</button>
                                </form>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png" alt="home" class="float-start me-1"/>
                                    <p class="">Jl. Dr. Wahidin No.116, Jatingaleh, Kec. Candisari, Kota Semarang, Jawa Tengah 50254</p>
                                </div>
                            </div>
                            <p class="card-text">CV Wirakata Studio adalah sebuah perusahaan dibidang desain arsitektur bangunan</b></p>                           
                            <!-- Button trigger modal -->
                        ...
                        <div class="card-body">
                                <div class="row align-items-start">
                                    <div class="col">
                                        ...
                                        <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png" alt="home" class="float-start me-1"/>
                                        <p class="">Jl. Imam Bonjol No.53, Pabean, Kec. Pekalongan Utara, Kota Pekalongan, Jawa Tengah 51146</p>
                                    </div>
                                </div>
                                <p class="card-text">CV Arcite Design adalah sebuah perusahaan dibidang desain arsitektur bangunan</b></p>
                                <!-- Button trigger modal -->
                            ...
                            <div class="card-body">
                                <div class="row align-items-start">
                                    <div class="col">
                                        ...
                                        <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png" alt="home" class="float-start me-1"/>
                                        <p class="">Jl. Adi Sucipto, Blukukan, Blulukan, Kec. Colomadu, Kabupaten Karanganyar, Jawa Tengah 57174</p>
                                    </div>
                                </div>
                                <p class="card-text">CV Karya Kreatif adalah sebuah perusahaan dibidang desain arsitektur bangunan</b></p>
                                <!-- Button trigger modal -->
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png" alt="home" class="float-start me-1"/>
                                    <p class="">Sabrang, Giripurwo, Kec. Girimulyo, Kabupaten Kulon Progo, Daerah Istimewa Yogyakarta 55674</p>
                                </div>
                            </div>
                            <p class="card-text">CV Wirakata Studio adalah sebuah perusahaan dibidang desain arsitektur bangunan</b></p>
                        ...
                        <div class="card-body">
                                <div class="row align-items-start">
                                    <div class="col">
                                        ...
                                        <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png" alt="home" class="float-start me-1"/>
                                        <p class="">Jl. Ring Road Utara, Kaliwaru, Condongcatur, Kec. Depok, Yogyakarta, Daerah Istimewa Yogyakarta 55283</p>
                                    </div>
                                </div>
                                <p class="card-text">CV Arcite Design adalah sebuah perusahaan dibidang desain arsitektur bangunan</b></p>
                                <!-- Button trigger modal -->
                            ...
                            <div class="card-body">
                                <div class="row align-items-start">
                                    <div class="col">
                                        ...
                                        <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png" alt="home" class="float-start me-1"/>
                                        <p class="">Jl. Imogiri Barat No.25a, Bakung, Bangunharjo, Kec. Sewon, Kabupaten Bantul, Daerah Istimewa Yogyakarta 55188</p>
                                    </div>
                                </div>
                                <p class="card-text">CV Karya Kreatif adalah sebuah perusahaan dibidang desain arsitektur bangunan</b></p>
                                <!-- Button trigger modal -->
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png" alt="home" class="float-start me-1"/>
                                    <p class="">Jl. Raya Pantura Cirebon, Kebonturi, Kec. Arjawinangun, Kabupaten Cirebon, Jawa Barat 45162</p>
                                </div>
                            </div>
                            <p class="card-text">CV Wirakata Studio adalah sebuah perusahaan dibidang desain arsitektur bangunan</b></p>
                        ...
                        <div class="card-body">
                                <div class="row align-items-start">
                                    <div class="col">
                                        ...
                                        <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png" alt="home" class="float-start me-1"/>
                                        <p class="">Perumahan Jl. Danau Bogor Raya, RT.02/RW.13, Katulampa, Kec. Bogor Tim., Kota Bogor, Jawa Barat 16144</p>
                                    </div>
                                </div>
                                <p class="card-text">CV Arcite Design adalah sebuah perusahaan dibidang desain arsitektur bangunan</b></p>
                                <!-- Button trigger modal -->
                            ...
                            <div class="card-body">
                                <div class="row align-items-start">
                                    <div class="col">
                                        ...
                                        <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png" alt="home" class="float-start me-1"/>
                                        <p class="">Jl. Jend. Sudirman No.107, Karanganyar, Kec. Astanaanyar, Kota Bandung, Jawa Barat 40241</p>
                                    </div>
                                </div>
                                <p class="card-text">CV Karya Kreatif adalah sebuah perusahaan dibidang desain arsitektur bangunan</b></p>
                                <!-- Button trigger modal -->
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png" alt="home" class="float-start me-1"/>
                                    <p class="">Jl. Tebet Barat Raya, RT.1/RW.10, Tebet Bar., Kec. Tebet, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12820</p>
                                </div>
                            </div>
                            <p class="card-text">CV Wirakata Studio adalah sebuah perusahaan dibidang desain arsitektur bangunan</b></p>
                        ...
                        <div class="card-body">
                                <div class="row align-items-start">
                                    <div class="col">
                                        ...
                                        <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png" alt="home" class="float-start me-1"/>
                                        <p class="">Prima center, Jl. Pool PPD Jl. Pesing Poglar No.2 2 B5, Kedaung Kali Angke, Kecamatan Cengkareng, Jakarta</p>
                                    </div>
                                </div>
                                <p class="card-text">CV Arcite Design adalah sebuah perusahaan dibidang desain arsitektur bangunan</b></p>
                                <!-- Button trigger modal -->
                            ...
                            <div class="card-body">
                                <div class="row align-items-start">
                                    <div class="col">
                                        ...
                                        <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png" alt="home" class="float-start me-1"/>
                                        <p class="">Jl. Senen Raya No.135, Senen, Kec. Senen, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10410</p>
                                    </div>
                                </div>
                                <p class="card-text">CV Karya Kreatif adalah sebuah perusahaan dibidang desain arsitektur bangunan</b></p>
                                <!-- Button trigger modal -->
