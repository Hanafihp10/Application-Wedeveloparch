        ...
        <div class="row ms-4 mt-5 me-4">
            <div class="col-sm-3">
                <div class="card shadow">
                    <div class="card-body text-center" style="font-size: 16px">
                        <h5 class="card-title" style="font-size: 15px"><b>Layanan Perusahaan</b></h5>
                        <hr>
                        <div style="font-size: 14px">
                            <p href="#" class="list-group-item list-group-item-action">Desain 3D</p>
                            <hr>
                            <p href="#" class="list-group-item list-group-item-action">Desain Interior & Eksterior</p>
                            <hr>
                            <p href="#" class="list-group-item list-group-item-action">Desain Landscape</p>
                            <hr>
                            <p href="#" class="list-group-item list-group-item-action">Detail Gambar Arsitektur</p>
                            <hr>
                            <p href="#" class="list-group-item list-group-item-action">Perancangan Denah</p>
                            <hr>
                            <p href="#" class="list-group-item list-group-item-action">Pembuatan DED</p>
                            <hr>
                            <p href="#" class="list-group-item list-group-item-action">Estimasi RAB</p>
                            <hr>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-9">
                <div class="card border-0">
                    <div class="card-body">
                        <h3><strong>Bangun Rumah Impianmu,<br><span class="text-danger"><b>Sekarang!</b></span></strong>
                        </h3>
                        <p style="font-size: 15px">Nikmati layanan kami yang akan diselesaikan oleh para ahli kontruksi.
                        </p>
                        <hr>
                        <img src="../asset/Image/Product-image/product-1.jpeg" class="portrait m-1"
                            style="border-radius: 5%; width:280px;  height:300px">
                        <img src="https://i.pinimg.com/236x/d6/64/cf/d664cfafd5b38379c5c0638695925bd9.jpg"
                            class="img-2 m-1 img-fluid" style="border-radius: 5%; width:150px;  height:300px">
                        <img src="https://i.pinimg.com/236x/d6/64/cf/d664cfafd5b38379c5c0638695925bd9.jpg"
                            class="img-2 m-1 img-fluid" style="border-radius: 5%; width:150px;  height:300px">
                        <img src="https://i.pinimg.com/236x/d6/64/cf/d664cfafd5b38379c5c0638695925bd9.jpg"
                            class="img-2 m-1 img-fluid" style="border-radius: 5%; width:150px;  height:300px">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4 ms-4 me-4 items-container">
                <div class="col item" data-region="jatim" data-service="desain">
                    <div class="card border-1 rounded-2 shadow">
                        <img src="http://localhost/Application-Wedeveloparch/asset/icon/logo-wirakata.jpeg"
                            class="card-img-top mx-auto d-block" alt="..." style="width: 100px; height: 100px">
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    <h5><b>CV Wirakata Studio</b></h5>
                                    <hr>
                                    <img width="20" height="auto" src="https://img.icons8.com/ios/50/marker--v1.png"
                                        alt="marker--v1" class="float-start me-1" />
                                    <p class="fs-20" value="jatim"> Surabaya </p>
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Jl. Setail No.1, Darmo, Kec. Wonokromo, Surabaya, Jawa Timur 60241</p>
                                </div>
                            </div>
                            <p class="card-text">CV Wirakata Studio adalah sebuah perusahaan dibidang desain arsitektur
                                bangunan</b></p>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="post" action="proses.php">
                                                <label for="nama_perusahaan">Perusahaan:</label><br>
                                                ...
                                                <select id="kategori_proyek_transaksi" name="kategori_proyek_transaksi"
                                                    required>
                                                ...
                                                <button type="submit" name="submit_transaksi"
                                                    class="bg-danger border-0 shadow text-light rounded-2 p-2">Submit
                                                    Pesanan</button>
                                            </form>
                                        </div>
                                    </div>
                ...
                <div class="col item" data-region="jatim" data-service="desain">
                    <div class="card border-1 rounded-2 shadow">
                        <img src="http://localhost/Application-Wedeveloparch/asset/icon/logo-arcite.jpeg"
                            class="card-img-top mx-auto d-block" alt="..." style="width: 100px; height: 100px">
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    <h5><b>CV Arcite Design</b></h5>
                                    <hr>
                                    <img width="20" height="auto" src="https://img.icons8.com/ios/50/marker--v1.png"
                                        alt="marker--v1" class="float-start me-1" />
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Jl. Merdeka Selatan, Kiduldalem, Kec. Klojen, Kota Malang, Jawa Timur
                                        65119</p>
                                </div>
                            </div>
                            <p class="card-text">CV Arcite Design adalah sebuah perusahaan dibidang desain arsitektur
                                bangunan</b></p>
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                data-bs-target="#exampleModal">
                                Pesan Sekarang
                ...
                <div class="col item" data-region="jatim" data-service="jasa">
                    <div class="card border-1 rounded-2 shadow">
                        <img src="http://localhost/Application-Wedeveloparch/asset/icon/logo-kreatif.jpeg"
                            class="card-img-top mx-auto d-block" alt="..." style="width: 100px; height: 100px">
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    <h5><b>CV Karya Kreatif</b></h5>
                                    <hr>
                                    <img width="20" height="auto" src="https://img.icons8.com/ios/50/marker--v1.png"
                                        alt="marker--v1" class="float-start me-1" />
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Jl. Panglima Sudirman, Kp. Dalem, Kec. Kota, Kota Kediri, Jawa Timur
                                        64129</p>
                                </div>
                            </div>
                            <p class="card-text">CV Karya Kreatif adalah sebuah perusahaan dibidang desain arsitektur
                                bangunan</b></p>
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                data-bs-target="#exampleModal">
                                Pesan Sekarang
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Jl. Dr. Wahidin No.116, Jatingaleh, Kec. Candisari, Kota Semarang, Jawa
                                        Tengah 50254</p>
                                </div>
                            </div>
                            <p class="card-text">CV Wirakata Studio adalah sebuah perusahaan dibidang desain arsitektur
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Jl. Imam Bonjol No.53, Pabean, Kec. Pekalongan Utara, Kota Pekalongan,
                                        Jawa Tengah 51146</p>
                                </div>
                            </div>
                            <p class="card-text">CV Arcite Design adalah sebuah perusahaan dibidang desain arsitektur
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Jl. Adi Sucipto, Blukukan, Blulukan, Kec. Colomadu, Kabupaten
                                        Karanganyar, Jawa Tengah 57174</p>
                                </div>
                            </div>
                            <p class="card-text">CV Karya Kreatif adalah sebuah perusahaan dibidang desain arsitektur
                                bangunan</b></p>
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Sabrang, Giripurwo, Kec. Girimulyo, Kabupaten Kulon Progo, Daerah
                                        Istimewa Yogyakarta 55674</p>
                                </div>
                            </div>
                            <p class="card-text">CV Wirakata Studio adalah sebuah perusahaan dibidang desain arsitektur
                                bangunan</b></p>
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Jl. Ring Road Utara, Kaliwaru, Condongcatur, Kec. Depok, Yogyakarta,
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Jl. Imogiri Barat No.25a, Bakung, Bangunharjo, Kec. Sewon, Kabupaten
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Jl. Raya Pantura Cirebon, Kebonturi, Kec. Arjawinangun, Kabupaten
                                        Cirebon, Jawa Barat 45162</p>
                                </div>
                            </div>
                            <p class="card-text">CV Wirakata Studio adalah sebuah perusahaan dibidang desain arsitektur
                                bangunan</b></p>
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Perumahan Jl. Danau Bogor Raya, RT.02/RW.13, Katulampa, Kec. Bogor Tim.,
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Jl. Jend. Sudirman No.107, Karanganyar, Kec. Astanaanyar, Kota Bandung,
                                        Jawa Barat 40241</p>
                                </div>
                            </div>
                            <p class="card-text">CV Karya Kreatif adalah sebuah perusahaan dibidang desain arsitektur
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Jl. Tebet Barat Raya, RT.1/RW.10, Tebet Bar., Kec. Tebet, Kota Jakarta
                                        Selatan, Daerah Khusus Ibukota Jakarta 12820</p>
                                </div>
                            </div>
                            <p class="card-text">CV Wirakata Studio adalah sebuah perusahaan dibidang desain arsitektur
                                bangunan</b></p>
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Prima center, Jl. Pool PPD Jl. Pesing Poglar No.2 2 B5, Kedaung Kali
                                        Angke, Kecamatan Cengkareng, Jakarta</p>
                                </div>
                            </div>
                            <p class="card-text">CV Arcite Design adalah sebuah perusahaan dibidang desain arsitektur
                                bangunan</b></p>
                        ...
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <img width="20" height="auto" src="https://img.icons8.com/sf-ultralight/25/home.png"
                                        alt="home" class="float-start me-1" />
                                    <p class="">Jl. Senen Raya No.135, Senen, Kec. Senen, Kota Jakarta Pusat, Daerah
                                        Khusus Ibukota Jakarta 10410</p>
                                </div>
                            </div>
                            <p class="card-text">CV Karya Kreatif adalah sebuah perusahaan dibidang desain arsitektur
                                bangunan</b></p>
